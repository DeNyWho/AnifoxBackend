...
//        const val tomcat = "org.apache.tomcat.embed:tomcat-embed-core:${Versions.tomcat}"
        ...
        object Defaults {
            ...
            const val webMVC = "org.springframework:spring-webmvc:${Versions.springWeb}"
            const val springCore = "org.springframework:spring-core:${Versions.springWeb}"
            const val springСontext = "org.springframework:spring-context:${Versions.springWeb}"
        }
        ...
        object swagger {
            ...
            const val swaggerOpenApi = "org.springdoc:springdoc-openapi-kotlin:${Versions.swagger}"
            const val swaggerDataRest = "org.springdoc:springdoc-openapi-data-rest:${Versions.swagger}"
        }
    }
